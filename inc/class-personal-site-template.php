...
class Personal_Site_Template {
	...
	public function do_wp_enqueue_scripts() {
		...
		wp_enqueue_script( 'turbolinks', get_stylesheet_directory_uri() .'/node_modules/turbolinks/dist/turbolinks.js', array(), '5.2.0', false );
		wp_enqueue_script( 'what-input', get_stylesheet_directory_uri() . '/node_modules/what-input/dist/what-input.js', array(), '5.2.6', false );
		wp_enqueue_script( 'foundation', get_stylesheet_directory_uri() . '/node_modules/foundation-sites/dist/js/foundation.js', array( 'jquery-core', 'what-input' ), '6.5.3', false );
		wp_enqueue_script( 'personal-site-js', get_stylesheet_directory_uri() . '/js/app.js', array( 'foundation' ), '1.0.0', false );
	}
